...
**About translations.** The handbook is written in English, and the English text is the authoritative source of truth. The handbook is also available in other languages, currently Chinese. Translations are provided as a convenience and may contain inaccuracies or lag behind the original; if you notice any issues with a translation, please let us know: feedback on translations is very welcome.
